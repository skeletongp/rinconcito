<li class="flex flex-row shadow-xl rounded-xl my-1 relative">
    ...
    <div class="select-none  flex flex-1 items-center p-4 w-full overflow-hidden">
        ...
        <div class="flex-1 pl-1 mr-16 ">
            <div class="font-bold text-lg w-60 dark:text-white truncate overflow-hidden mb-1 leading-5">
                {!! $title !!}
            </div>
            <div class="text-gray-600 dark:text-gray-200 text-sm flex space-x-2 overflow-hidden">
                {!! $subtitle !!}
            </div>
        </div>
