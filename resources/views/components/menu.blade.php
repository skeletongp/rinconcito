<aside id="sidebar" class="fixed  rounded-xl z-20  bg-left bg-cover w-2/3 md:w-1/2 lg:w-2/6 xl:w-1/6 hidden "
    ...
    <ul class="p-4 font-bold flex flex-col space-y-4">
        ...
        @role('admin')
            ...
            <x-dropdown contentClasses="bg-menu py-3 px-2">
                <x-slot name="trigger">
                    <x-dropdown-link :active="request()->routeIs('outcomes.*')"
                        class="flex justify-start space-x-2 items-center cursor-pointer hover:bg-gray-900 hover:text-white p-3 border-b-2">
                        <div class="w-1/6 h-full">
                ...
                <x-slot name="content">
                    <div class="px-2 space-y-2">
                        <x-dropdown-link :active="request()->routeIs('outcomes.index')"
                        ...
                        <x-dropdown-link :active="request()->routeIs('outcomes.create')"
                            href="{{ route('outcomes.create') }}"
                            class="flex justify-start space-x-2 items-center hover:bg-gray-800 hover:text-white p-3 border-b-2">
                            <div class="w-1/6 h-full">
                                <span class="fas fa-plus text-lg"></span>
                            </div>
        ...
        @role('admin')
            ...
            <x-dropdown-link href="{{ route('sales.show') }}" :active="request()->routeIs('sales.show')"
                class="flex justify-start space-x-2 items-center cursor-pointer hover:bg-gray-900 hover:text-white p-3 border-b-2">
                <div class="w-1/6 h-full">
