...
<div class="bg-white dark:bg-gray-800 rounded-md"> 
    ...
    <div class=" py-1 px-1 flex justify-between items-center rounde-md rounded-md border relative overflow-hidden <?php echo e($class); ?>">
...
<?php /**PATH D:\laragon\www\holy-hope\resources\views/components/input.blade.php ENDPATH**/ ?>