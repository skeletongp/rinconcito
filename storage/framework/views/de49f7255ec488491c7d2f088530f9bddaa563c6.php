...
<?php endif; ?>
        ...
        <div class="card_image w-full h-full bg-cover bg-center bg-no-repeat "
            style="background-image: url(<?php echo e(asset($photo)); ?>)">
            <?php if($show): ?>
        ...
        <div class="card__overlay">
            <div class="card__header">
                ...
                <div class="card__thumb flex items-center justify-center <?php echo e($stock ? 'bg-green-500' : 'bg-red-500'); ?>"
                    alt="">
                    <button>
                        <span class="fas <?php echo e($stock ? 'fa-check' : 'fa-times'); ?> text-white">
                        </span>
                    </button>
                </div>
                <div class="card__header-text">
                    <div
                        class="card__title flex justify-start space-x-4 <?php echo e($stock ? '' : 'line-through'); ?> mx-2 md:mx-0
                    ">
                        <div class="flex items-center space-x-2">
                            <span class="font-medium capitalize"><?php echo e(substr($name, 0, 20)); ?></span>-
                            <div class="w-24 ">
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.input','data' => ['type' => 'number','name' => 'price','value' => ''.e(old('price', $price)).'','class' => '','required' => true]]); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['type' => 'number','name' => 'price','value' => ''.e(old('price', $price)).'','class' => '','required' => true]); ?>
...
<?php /**PATH D:\laragon\www\coffetech\resources\views/components/card-product.blade.php ENDPATH**/ ?>