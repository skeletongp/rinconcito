...
<?php $__env->startSection('body'); ?>
    <div class="max-w-4xl mx-auto bg-white p-4 rounded-xl relative">
        ...
        <ul class="cards grid grid-cols-1 md:grid-cols-2 m-3 lg:m-8">
            <a href="<?php echo e(route('users.create')); ?>" class="absolute font-bold top-3 left-3 p-3 flex space-x-1 items-center">
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\coffetech\resources\views/pages/users/index.blade.php ENDPATH**/ ?>