                    ...
                    <div class=" flex items-center  my-2 rounded-xl shadow-xl bg-gray-100">
                        ...
                        <div class="w-3/12 text-xl  px-4 py-2 rounded-r-xl flex items-center space-x-4 justify-between">
                            <div class="w-7 h-7 text-center  font-semibold rounded-full bg-white">
                                <form action="<?php echo e(route('ingredients.destroy', $ing)); ?>" method="POST" id="i<?php echo e($ing->id); ?>">
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\coffetech\resources\views/pages/ingredients/index.blade.php ENDPATH**/ ?>