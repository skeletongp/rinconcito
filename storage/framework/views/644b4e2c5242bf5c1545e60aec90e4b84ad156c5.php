                                    ...
                                    <div class="flex justify-between w-full pb-2 space-x-2">
                                        ...
                                        <div class="text-right w-full">
                                            <p class="text-md font-semibold"> <?php echo e($cart->cant); ?> x
                                                $<?php echo e(number_format($cart->product->price, 2)); ?></p>
                                            <p class=" text-sm md:text-lg font-semibold">Total.
                                                $<?php echo e(number_format($cart->cant * $cart->product->price, 2)); ?></p>
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\holy-hope\resources\views/pages/carts/index.blade.php ENDPATH**/ ?>