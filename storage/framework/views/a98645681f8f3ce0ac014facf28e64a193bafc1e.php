                ...
                <div class=" flex items-center  my-2 rounded-xl shadow-xl bg-gray-100 <?php echo e($ing->stock>0?'':'line-through'); ?>">
                    ...
                    <div class="w-3/12 text-xl  px-4 py-2 rounded-r-xl flex items-center space-x-4 justify-end">
                        <div class="w-7 h-7 text-center  font-semibold rounded-full bg-white">
                            <form action="<?php echo e(route('ingredients.remove')); ?>" method="POST">
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\holy-hope\resources\views/pages/products/add-ingredients.blade.php ENDPATH**/ ?>