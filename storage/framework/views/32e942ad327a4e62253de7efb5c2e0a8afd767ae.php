...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.grid-stat','data' => ['dataUp' => 'Productos','dataDown' => 'Consulta el cátalogo','bg' => 'bg-red-vibrant','icon' => 'fa-layer-group','url' => ''.e(route('products.index')).'']]); ?>
<?php $component->withName('grid-stat'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['dataUp' => 'Productos','dataDown' => 'Consulta el cátalogo','bg' => 'bg-red-vibrant','icon' => 'fa-layer-group','url' => ''.e(route('products.index')).'']); ?>
...
<?php endif; ?>
        ...
        <div class="flex  flex-col md:flex-row lg:flex-row mx-2 w-full justify-center">
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.grid-stat','data' => ['dataUp' => 'Pendientes','dataDown' => 'Pedidos por entregar','bg' => 'bg-info','icon' => 'fa-hourglass-half','url' => ''.e(route('invoices.pendings')).'']]); ?>
<?php $component->withName('grid-stat'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['dataUp' => 'Pendientes','dataDown' => 'Pedidos por entregar','bg' => 'bg-info','icon' => 'fa-hourglass-half','url' => ''.e(route('invoices.pendings')).'']); ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.grid-stat','data' => ['dataUp' => 'Entregados','dataDown' => 'Ventas de Hoy','bg' => 'bg-red-vibrant','icon' => 'fa-check-double']]); ?>
<?php $component->withName('grid-stat'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['dataUp' => 'Entregados','dataDown' => 'Ventas de Hoy','bg' => 'bg-red-vibrant','icon' => 'fa-check-double']); ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
...
<?php /**PATH D:\laragon\www\holy-hope\resources\views/components/panel-control.blade.php ENDPATH**/ ?>